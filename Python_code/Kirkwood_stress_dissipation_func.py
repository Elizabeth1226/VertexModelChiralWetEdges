...
def Kirkwood_stress_dissipation_func(kP, P0, time, rho_0, folder_path, Lb, gammaW):
    """
    ...
    for cid in range(Nc): # cells are 1-indexed (1, 2, ..., Nc)
    ...
    for cid in range(Nc):
        ...
        for i in range(Nv_current):
            ...
            outerProduct_current += np.outer(r_current, v_current) # unsymmetrized outer product
