"""
Radial velocity time-averaged plotting function

Computes and plots time-averaged radial velocity profiles
"""

import numpy as np
import matplotlib.pyplot as plt
from Vr_ave_func import Vr_ave_func


def Vr_time_ave_plot_func(P0, C1, dw, start_time, i, j, k, filepath):
    """
    Compute time-averaged radial velocity and create error bar plot
    ...
    """
    # Compute radial velocity at different time points
    T30_1, V30_1 = Vr_ave_func(filepath, start_time)
    T35_1, V35_1 = Vr_ave_func(filepath, start_time + 1*dw)
    T40_1, V40_1 = Vr_ave_func(filepath, start_time + 2*dw)
    T45_1, V45_1 = Vr_ave_func(filepath, start_time + 3*dw)
    T50_1, V50_1 = Vr_ave_func(filepath, start_time + 4*dw)
