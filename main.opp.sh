#!/bin/bash -l
echo =========================================================   
echo Job submitted  date = Sun 29 Mar 22:35:12 BST 2026      
date_start=`date +%s`
...
export OMP_NUM_THEADS=1
 /usr/local/shared/slurm/bin/srun -u -n 1 --mpi=pmix --mem-per-cpu=1024 nice -n 10 /mnt/users/wangg/VertexModelChiralWetEdges/./main.opp 60 0.5 0.01 4.0 0.02 1000 50 50 0.05 0 4 0 1 1 2 1 128 0 20 2 20 5 40
  echo ---------------                                           
